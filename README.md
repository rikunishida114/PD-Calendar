...
PD-Calendar は、カレンダー管理・フォルダ管理・AIタスク分解を統合した個人向けタスク管理ツールです。特徴的なのは、ユーザーが作成した「目的＋タスク群」の履歴を学習し自分自身の思考に最適化されたタスク分割テンプレートが自動で育っていく点です。シンプルな UI で毎日のタスクを管理しつつ使えば使うほど「自分に合ったタスク提案」が得られることを目指して設計しています。
